...
<div align="left">
  <a href="https://huggingface.co/datasets/biokg-llm25/Dataset_biokgllm/resolve/main/kg.csv" download>
...
**[Download the KG Dataset (CSV)](https://huggingface.co/datasets/biokg-llm25/Dataset_biokgllm)** to explore clinically relevant information beyond molecular data.
...
- *Ready-to-Use Dataset:*  The resulting knowledge graph can be downloaded from [Hugging Face Hub](https://huggingface.co/datasets/biokg-llm25/Dataset_biokgllm) in a ready-to-use CSV format.

...
- Saves the formatted HTML source into 'sourcecode_hpra.rtf' using RTF syntax
"""
...
with open('sourcecode_hpra.rtf', 'w', encoding='utf-8') as file:                                # Output file to save the HTML source code
    for page_num in range(1, 500):
        ...
        file.write("\\par\n\\par\n")                                                            
        print(f"HTML source code for page {page_num} appended to 'sourcecode_hpra.rtf'")

print("HTML source code for all pages saved in 'sourcecode_hpra.rtf'.")

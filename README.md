...
<div align="left">
  <a href="https://huggingface.co/datasets/medaka25/MEDAKA/resolve/main/kg.csv?download=true" download>
...
- *Ready-to-Use Dataset:*  The resulting knowledge graph can be downloaded from [Hugging Face Hub](https://huggingface.co/datasets/medaka25/MEDAKA) in a ready-to-use CSV format.

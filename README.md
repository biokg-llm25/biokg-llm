...
**[Download the KG Dataset (CSV) from Hugging Face Hub](https://huggingface.co/datasets/biokg-llm25/Dataset_biokgllm)** to explore clinically relevant information beyond molecular data.
